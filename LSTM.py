...
for t in mercados:
    ...
    for c in range(iters):
        ...
        if comb[sel][0] == 1:
            lstm_model = models.Sequential([
                layers.LSTM(units=comb[sel][2], activation = "relu", 
            ...
            lstm_model.add(layers.LSTM(units=comb[sel][2], 
    ...
    if best_n_LSTM == 1:
        lstm_model = models.Sequential([
            layers.LSTM(units=best_unit, activation = "relu", 
                        input_shape = (horas[cont]+horas[cont+1], 150), 
        ...
        lstm_model.add(layers.LSTM(units=best_unit, 
                                   return_sequences=False, 
